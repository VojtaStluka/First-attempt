...
def vyber_studenty_dataclass(studenti: list[Student], min_vek: int = 10, obor: Obor | None = None) -> list[Student]: #jestliže se nezadá min_vek, je by defauilt 10; Obor může Obor nebo None, jinak je None
    obor_value = obor 
    vybrani = [student for student in studenti if student.vek >= min_vek and (student.obor == obor_value or obor_value is None)]
    return vybrani

print(vyber_studenty_dataclass(studenti_dataclass, 20, Obor.INFORMATIKA))
