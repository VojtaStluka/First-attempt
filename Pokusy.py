...
class BinaryHeap:
    ...
    def head(self):
        ...
        min_idx = 0
        print(self.heap[min_idx])
       
'''
bh = BinaryHeap()
bh.push(Element("task1", 3))
bh.push(Element("task2", 1))
bh.push(Element("task3", 2))

print(bh.pop())  # Mělo by vrátit Element("task2", 1)
print(bh.pop())  # Mělo by vrátit Element("task3", 2)
print(bh.pop())  # Mělo by vrátit Element("task1", 3)'''
